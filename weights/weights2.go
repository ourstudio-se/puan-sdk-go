...
func CalculateObjective(primitives, selectedPrimitives []string, xorWithPreference []XORWithPreference) Weights {
	...
	selectedWeights := calculateSelectedWeights(selectedPrimitives, notSelectedSum, sumOfPreferredWeights)
...
func calculateSelectedWeights(selectedPrimitives []string, notSelectedSum, preferredWeightsSum int) Weights {
...
func calculatePreferredWeights(xorWithPreference []XORWithPreference, notSelectedSum int) (Weights, Weights) {
