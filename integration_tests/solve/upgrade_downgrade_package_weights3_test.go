...
func Test_exactlyOnePackage_upgrade_case1_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
...
func Test_exactlyOnePackage_upgrade_case2_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func Test_exactlyOnePackage_upgrade_case3_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func Test_exactlyOnePackage_upgrade_case4_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func Test_exactlyOnePackage_downgrade_case1_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func Test_exactlyOnePackage_downgrade_case2_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func Test_exactlyOnePackage_downgrade_case3_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func Test_exactlyOnePackage_downgrade_case4_w3(t *testing.T) {
	model, xorWithPreference := exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
...
func exactlyOnePackageOfThreeAvailableWithPreferredAsSmallest_w3() (*pldag.Model, []string) {
	model := pldag.New()
