...
func Test_exactlyOnePackage_selectNotPreferredThenPreferred_shouldReturnPreferred_w3(t *testing.T) {
	model, xorWithPreferred := exactlyOnePackageOfTwoAvailableWithLargerNotPreferred_w3()
...
func Test_exactlyOnePackage_selectNotPreferred_shouldReturnNotPreferred_w3(t *testing.T) {
	model, xorWithPreferred := exactlyOnePackageOfTwoAvailableWithLargerNotPreferred_w3()
	polyhedron := model.GeneratePolyhedron()
	client := glpk.NewClient(url)
	selections := puan.Selections{
...
func exactlyOnePackageOfTwoAvailableWithLargerNotPreferred_w3() (*pldag.Model, []string) {
	model := pldag.New()
