...
func Test_exactlyOnePackage_selectPreferredThenNotPreferred_shouldReturnNotPreferred_w3(t *testing.T) {
	model := pldag.New()
...
func Test_packageImpliesAnotherPackage_selectedAndDeselect_shouldReturnCheapestSolution_w3(t *testing.T) {
	model := pldag.New()
...
func Test_exactlyOnePackage_selectAndDeselectNotPreferred_shouldReturnPreferred_w3(t *testing.T) {
	model := pldag.New()
...
func Test_exactlyOnePackage_nothingIsSelected_shouldReturnPreferred_w3(t *testing.T) {
	model := pldag.New()
...
func Test_implicationChain_shouldReturnAllAsTrue_w3(t *testing.T) {
	model := pldag.New()
